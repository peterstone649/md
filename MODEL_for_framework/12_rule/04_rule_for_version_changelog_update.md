# Rule for Version Changelog Update [RULE_FOR_MFW_VERSION_CHANGELOG_UPDATE] **[PRIO: HIGH]**
...
### Related Conventions
- **[01_convention_for_version.md](../20_convention/01_convention_for_version.md)** - Defines version format and numbering conventions
- **[02_convention_for_date.md](../20_convention/02_convention_for_date.md)** - Defines date format standards
...
|---------|------|---------|-------------|----------------------|
| V1.0.3 | 2026-02-07 | Added Related Conventions section with clickable references to version and date convention files | AI Framework Steward | Ensure proper integration with foundational version and date format conventions |
| V1.0.2 | 2026-01-31 | Small refine change: Updated working instructions reference and minor documentation improvements | AI Framework Steward | Minor documentation refinement and instruction updates |
| V1.0.1 | 2026-01-23 | Updated title formatting and changed metadata headers per RULE_FOR_MFW_TITLE_FORMAT | Framework Admin | Ensure framework-wide consistency |
