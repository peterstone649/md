...
- **📤 Use** — Use the framework for any purpose ([PERSONAL_COMMERCIAL])
- **🔄 Modify** — Modify the framework and create derivatives
...
- **📋 License Copy** — Provide [LICENSE_TYPE] text with distributions
...
**Complete [LICENSE_TYPE] text:** [[LICENSE_URL]]([LICENSE_URL])
...
This **[FRAMEWORK_NAME]** embraces **[OPEN_SCIENCE_DESCRIPTION]** while protecting **[CORE_PROTECTION_DESCRIPTION]**:

- **🔒 Core Protection** — [CORE_PROTECTION_ITEM_1]
- **🚀 Expansion Freedom** — [CORE_PROTECTION_ITEM_2]
- **🤝 Collaboration** — [CORE_PROTECTION_ITEM_3]
- **🔍 Transparency** — [CORE_PROTECTION_ITEM_4]
- **⚖️ Share-Alike** — [CORE_PROTECTION_ITEM_5]
...
| `[LICENSE_URL]` | Full license text URL | https://joinup.ec.europa.eu/collection/eupl/eupl-text-11-12 |
| `[LICENSE_LANGUAGES_URL]` | License translations URL | https://joinup.ec.europa.eu/collection/eupl/eupl-licence |
| `[FRAMEWORK_PORTAL_URL]` | Framework website | https://framework.example.com |
| `[FRAMEWORK_NAME]` | Framework name | MODEL_for_framework |
| `[OPEN_SCIENCE_DESCRIPTION]` | Open science commitment | open science principles |
