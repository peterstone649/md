...
please note: this term template is different from other term templates because of  section "Field-Focus-Question List"
...
**[FIELD_1]** → **[FOCUS_OF_TERM]** → *"KEY_QUESTION_ANSWERED"*

**[FIELD_2]** → **[FOCUS_OF_TERM]** → *"KEY_QUESTION_ANSWERED"*

**[FIELD_3]** → **[FOCUS_OF_TERM]** → *"KEY_QUESTION_ANSWERED"*

**[FIELD_4]** → **[FOCUS_OF_TERM]** → *"KEY_QUESTION_ANSWERED"*

**[FIELD_5]** → **[FOCUS_OF_TERM]** → *"KEY_QUESTION_ANSWERED"*
