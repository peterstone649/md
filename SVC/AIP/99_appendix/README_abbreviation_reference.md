...
| **evolution** | Evolution | `##_evolution_*.md` |
| **failure** | Failure | `##_failure_*.md` |
| **principle** | Principle | `##_principle_*.md` |
| **priority** | Priority | `##_priority_*.md` |
| **scope** | Scope | `##_scope_*.md` |
| **skill** | Skill | `##_skill_*.md` |
...
|--------------|-----------|---------|
| **VMS** | Value Management System | Core Value framework name |
